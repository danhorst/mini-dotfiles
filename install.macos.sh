#!/bin/bash
# macOS-only install steps, sourced by install.sh.
# Relies on helpers and the variables dotfiles_directory / network_force from
# install.sh + lib/common.sh.
# shellcheck disable=SC2154  # dotfiles_directory and network_force come from install.sh
